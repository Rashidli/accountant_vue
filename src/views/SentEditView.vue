<template>
    <div class="about">
      <div class="container">
        ...
        <div v-if="sent_show.productItems && sent_show.productItems.length">
          <table>
            <tr>
              <th>Məhsul</th>
              <th>Ölçü vahidi</th>
            ...
            <tr v-for="(product, i) in sent_show.productItems" :key="i">
              <td>
  ...
  export default {
    ...
    methods: {
      ...
      showData() {
        axios
          ...
          .then((response) => {
            ...
            this.sent_show.productItems = response.data.sent_products;
      ...
      updateData() {
          this.sent_show.total_price = this.totalItemsAmount
        axios
          .post(
            "https://sheet.washing.az/api/sent_update/" + this.$route.params.id, this.sent_show
          )
          .then((response) => {
      ...
      addNewProduct() {
        ...
        this.itemMeasure &&
          this.itemQuantity &&
          this.itemPrice &&
          this.sent_show.productItems.push({
            name: this.itemName,
      ...
      updateTotalAmount() {
        ...
        this.sent_show.productItems.forEach((item) => {
      ...
      removeProductAt(productIndex) {
        this.sent_show.productItems = this.sent_show.productItems.filter((p, i) => {
